...
class _QuestionScreenState extends State<QuestionScreen> {
  ...
  void _submitQuiz() {
    ...
    if (widget.quizSet.name == "ตรวจสุขภาพ") {
      ...
      // ตรวจสอบการกรอกค่าน้ำตาลในเลือดในคำถามข้อที่ 5
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.quizSet.name == 'HIV'
              ? 'เลือกโปรแกรมตรวจที่เกี่ยวข้องกับ HIV'
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ถ้าเป็นคำถามข้อที่ 4 และเลือกตัวเลือกที่ 1 จะแสดงช่องให้กรอกค่าความดันโลหิต
